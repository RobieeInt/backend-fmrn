            ...
            <div class="w-full md:w-5/6 px-4 mb-4 md:mb-0">
                <div class="flex flex-wrap mb-3">
                    ...
                    <div class="w-1/6">
                        ...
                        <div class="text-xl">{{ number_format($item->quantity) }}</div>
                    </div>
                    <div class="w-1/6">
                        <div class="text-sm">Total</div>
                        <div class="text-xl">{{ number_format($item->total) }}</div>
                    </div>
                    <div class="w-1/6">
                ...
                <div class="flex flex-wrap mb-3">
                    ...
                    <div class="w-3/6">
                        ...
                        <div class="text-xl">{{ $item->user->email }}</div>
                    </div>
                    <div class="w-1/6">
                        <div class="text-sm">City</div>
                        <div class="text-xl">{{ $item->user->city }}</div>
                    </div>
                </div>
                <div class="flex flex-wrap mb-3">
                    <div class="w-4/6">
                    ...
                    <div class="w-1/6">
                        ...
                        <div class="text-xl">{{ number_format($item->user->houseNumber) }}</div>
                    </div>
                    <div class="w-1/6">
                        <div class="text-sm">Phone</div>
                        <div class="text-xl">{{ $item->user->phoneNumber }}</div>
                    </div>
                </div>
                <div class="flex flex-wrap mb-3">
                    <div class="w-5/6">
